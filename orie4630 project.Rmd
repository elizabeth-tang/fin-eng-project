...
### ** Wherever CARZ appears, it represents the auto manufacturer industry's overall performance
...
alpha_beta = data.frame(
  Portfolio = c("TSLA", "TM", "BYDDY", "Auto Industry", "Tan PF (opt)"),
  alpha_values = c(coef(tsla_fit)["(Intercept)"], coef(tm_fit)["(Intercept)"], coef(byddy_fit)["(Intercept)"], coef(auto_fit)["(Intercept)"], coef(pf_fit)["(Intercept)"]),
